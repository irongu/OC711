...
void OLED_ShowStringDelay(u8 x,u8 y,u8 *chr,u8 Char_Size,u16 delaym)
{
	unsigned char j=0;
	while (chr[j]!='\0')
	{		OLED_ShowChar(x,y,chr[j],Char_Size);
...
// 	GPIO_SetBits(GPIOA,GPIO_Pin_5|GPIO_Pin_7);	
	...
	OLED_WR_Byte(0x20,OLED_CMD);//亮度45
	...
	OLED_WR_Byte(0x1,OLED_CMD);//扫描速度，越大越快80
	...
	OLED_WR_Byte(0x14,OLED_CMD);/* Set_Charge_Pump 0x14:9v; 0x15 7.5v 0x10 off*/
